...
const ScheduleConfigurationInput = ({ state, dispatch, Users }) => {
  const FORM_LIST = [
    {
    ...
    {
      FormLabel:
        'Please enter the maximum number of hours you would like to set as a limit for generating the work schedule:',
      FormValue: state.limiter,
      Action: ACTIONS.UPDATE_LIMITER,
      MenuType: 'select',
    },
    {
